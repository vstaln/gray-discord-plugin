...
`gray_discord/hermes_text.py`: `utf16_len` and `_prefix_within_utf16_limit`
copied from `gateway/platforms/base.py` in that checkout. Their original
comment credits nearai/ironclaw#2304 for the UTF-16 discrepancy.
...
in this package, not a verbatim copy of Hermes' large adapter. The package
uses discord.py rather than bundling Hermes' gateway or agent runtime.
